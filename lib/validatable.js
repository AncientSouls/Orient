...
function mixin(superClass) {
    return class ValidatableQuery extends superClass {
        ...
        data(data) {
            assert.ok(_.isBoolean(data) || _.isNumber(data) || _.isString(data), `Wrang TData ${data}`);
        ...
        logical(logical) {
            ...
            if (!_.isArray(logical.logicals))
                logical.logicals = [];
            if (!_.isArray(logical.conditions))
                logical.conditions = [];
...
exports.mixin = mixin;
exports.MixedValidatableQuery = mixin(query_1.Query);
class ValidatableQuery extends exports.MixedValidatableQuery {
}
exports.ValidatableQuery = ValidatableQuery;
